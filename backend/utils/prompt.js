...
const I_CAN_PROMPT = PromptTemplate.fromTemplate(`
...
const BASIC_PROMPT = PromptTemplate.fromTemplate(`
...
const DETAIL_PROMPT = PromptTemplate.fromTemplate(`
...
const DETAIL_TITLE_PROMPT = PromptTemplate.fromTemplate(`
Act as a helper of technical exam for human, especially pilots. Your name is "RCPC AI Chatbot". 
It will be provided content realted with exam.
...
const PROFILE_PROMPT = PromptTemplate.fromTemplate(
