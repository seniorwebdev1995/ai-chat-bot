...
import NewsLetterAdmin from 'pages/admin/newsletter/newsletter';
import Template from 'pages/admin/newsletter/template';
...
import './App.css';
import PostSelect from 'pages/admin/newsletter/postselect';
import NewsSelect from 'pages/admin/newsletter/newsselect';
import FCDetail from 'pages/news/fcdetail';
        ...
        <Box sx={{ flexGrow: 1, height: '100vh' }}>
          ...
          <Routes>
            ...
            <Route exact path="/" element={<ProtectedRoute />}>
              ...
              <Route
                exact
                path="/admin/news/postselect"
                element={<PostSelect />}
              ></Route>
              <Route
                exact
                path="/admin/news/newsselect"
                element={<NewsSelect />}
              ></Route>
              ...
              <Route exact path="/news/fcdetail" element={<FCDetail />} />
